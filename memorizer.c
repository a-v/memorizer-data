...
static int kmap_seq_show(struct seq_file *seq, void *v)
{
	...
	switch(kobj->alloc_type)
	{
		case MEM_STACK:
			allocStr = "STACK";
			break;
		case MEM_STACK_FRAME:
			allocStr = "STACK_FRAME";
			break;
		case MEM_STACK_ARGS:
			allocStr ="STACK_ARGS";
			break;
		...
		case MEM_KMEM_CACHE_ND:
			allocStr = "KMEM_CACHE_ND";
			break;
		case MEM_ALLOC_PAGES:
			allocStr = "ALLOC_PAGES";
			break;
		case MEM_VMALLOC:
			allocStr = "VMALLOC";
			break;
		case MEM_INDUCED:
			allocStr = "INDUCED_ALLOC";
			break;
		case MEM_BOOTMEM:
			allocStr = "BOOTMEM";
			break;
	...
	seq_printf(seq,"%-p,%d,%p,%lu,%lu,%lu,%p,%s,%s,%s\n",
			...
			kobj->free_ip, allocStr, kobj->comm,
			kobj->slabname);
